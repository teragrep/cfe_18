...
public class HostRelpControllerTest extends TestSpringBootInformation {
    ...
    @Test
    @Order(1)
    public void testInsertRelpHost() {
    ...
    @Test
    @Order(5)
    public void testDeleteNonExistentHost() {
