...
public class Cfe04StorageIndexControllerTest extends TestSpringBootInformation {
    ...
    @Test
    @Order(1)
    @Description("Test valid cfe04 storage index insertion")
    public void testInsertStorageIndex() {
        ...
        // Creates the request
        HttpPut request = new HttpPut("http://localhost:" + port + "/v2/storages/definitions/cfe_04/1/indexes");
        // set requestEntity to the put request
        ...
        // Creating expected message as JSON Object from the data that was sent towards endpoint
        String expected = "New index linked to storage";
    ...
    @Test
    @Order(2)
    @Description("Test insert invalid index id to cfe04 storage")
    public void testInsertInvalidIndexId() {
        Cfe04StorageIndex cfe04StorageSourcetype = new Cfe04StorageIndex();
        cfe04StorageSourcetype.setIndexId(67);
        cfe04StorageSourcetype.setColdpath("coldPath");
        cfe04StorageSourcetype.setDisabled(true);
        cfe04StorageSourcetype.setHomePath("homePath");
        cfe04StorageSourcetype.setThawedPath("thawedPath");
        cfe04StorageSourcetype.setRepFactor("repFactor");
    ...
    @Test
    @Order(3)
    @Description("Test insert invalid cfe04 id to index")
    public void testInsertInvalidCfe04Id() {
        Cfe04StorageIndex cfe04StorageSourcetype = new Cfe04StorageIndex();
        cfe04StorageSourcetype.setIndexId(1);
        cfe04StorageSourcetype.setColdpath("coldPath");
        cfe04StorageSourcetype.setDisabled(true);
        cfe04StorageSourcetype.setHomePath("homePath");
        cfe04StorageSourcetype.setThawedPath("thawedPath");
        ...
        // Creates the request
        HttpPut request = new HttpPut("http://localhost:" + port + "/v2/storages/definitions/cfe_04/67/indexes");
        // set requestEntity to the put request
        request.setEntity(requestEntity);
        // Header
        request.setHeader("Authorization", "Bearer " + token);
    ...
    @Test
    @Order(4)
    @Description("Test delete cfe04 storage index")
    public void testDeleteCfe04StorageIndex() {
        // Creates the request
        ...
        // Creating expected message as JSON Object from the data that was sent towards endpoint
        String expected = "Index deleted from cfe_04 storage";
