...
public class StorageIndexControllerTest extends TestSpringBootInformation {
    ...
    public void testCreateValid() {
        ...
        storageIndex.setIndex("audit_relp");
        storageIndex.setStorageId(1);

        String json = gson.toJson(storageIndex);

        // forms the json to requestEntity
        StringEntity requestEntity = new StringEntity(String.valueOf(json), ContentType.APPLICATION_JSON);

        // Creates the request
        HttpPut request = new HttpPut("http://localhost:" + port + "/v2/storages/indexes");
        ...
        String expected = "Index linked to a storage";
    ...
    public void testCreateInvalidStorage() {
        ...
        HttpPut requestPut = new HttpPut("http://localhost:" + port + "/v2/storages/indexes");
    ...
    public void testCreateInvalidIndex() {
        StorageIndex storageIndex = new StorageIndex();
        storageIndex.setIndex("invalidIndex");
        storageIndex.setStorageId(1);
