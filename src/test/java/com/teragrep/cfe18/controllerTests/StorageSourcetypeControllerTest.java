...
import com.teragrep.cfe18.handlers.entities.StorageSourcetype;
...
public class StorageSourcetypeControllerTest extends TestSpringBootInformation {
    ...
    public void testData() {
        ...
        testApiClient.insertSink(flowId, "501", "10.10.10.10", "tls");
        testApiClient.insertCapture("relpTag", "P30D", "audit", "relp", "audit_relp", "relpsource1", "tls", "flow1");
        testApiClient.insertCfe04Storage("cfe04");
    }
    ...
    public void testCreateValid() {
        ...
        StorageSourcetype StorageSourcetype = new StorageSourcetype();
        StorageSourcetype.setSourcetype("relpsource1");
        StorageSourcetype.setStorageId(1);

        String json = gson.toJson(StorageSourcetype);

        // forms the json to requestEntity
        StringEntity requestEntity = new StringEntity(String.valueOf(json), ContentType.APPLICATION_JSON);

        // Creates the request
        HttpPut request = new HttpPut("http://localhost:" + port + "/v2/storages/sourcetypes");
        ...
        String expected = "Sourcetype linked to a storage";
    ...
    public void testCreateInvalidStorage() {
        StorageSourcetype StorageSourcetype = new StorageSourcetype();
        StorageSourcetype.setSourcetype("relpsource1");
        StorageSourcetype.setStorageId(67);
        ...
        HttpPut requestPut = new HttpPut("http://localhost:" + port + "/v2/storages/sourcetypes");

        requestPut.setHeader("Authorization", "Bearer " + token);
        requestPut.setEntity(requestEntity);

        HttpResponse responseGet = Assertions
                .assertDoesNotThrow(() -> HttpClientBuilder.create().build().execute(requestPut));
    ...
    @Test
    @Order(3)
    public void testCreateInvalidSourcetype() {
        StorageSourcetype StorageSourcetype = new StorageSourcetype();
        StorageSourcetype.setSourcetype("invalidSourcetype");
        StorageSourcetype.setStorageId(1);
