...
public class CaptureSourcetypeControllerTest extends TestSpringBootInformation {
    ...
    public void testData() {
        ...
        testApiClient.insertCapture("tag2", "P30D", "category", "application", "index1", "sourcetype2", "TLS", "flow1");
    ...
    public void testGetSourcetypes() {
        ...
        HttpGet requestGet = new HttpGet("http://localhost:" + port + "/v2/captures/definitions/sourcetypes");
        ...
        jsonObjectBuilder.add("sourcetype", "sourcetype1");
        ...
        jsonObjectBuilder2.add("sourcetype", "sourcetype2");
    ...
    @Test
    @Order(2)
    public void testGetSourcetypesNoDupes() {
        // Add another capture with same index. No dupes should be returned.
        TestApiClient testApiClient = new TestApiClient(port, token);
        testApiClient.insertCapture("tag3", "P30D", "category", "application", "index", "sourcetype1", "TLS", "flow1");
