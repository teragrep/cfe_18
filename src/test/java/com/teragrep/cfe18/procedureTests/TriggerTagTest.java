    ...
    */
    public void testTagTriggerBounce() throws Exception {
        ...
        SQLException state = Assertions.assertThrows(SQLException.class, () -> {
            ...
            stmnt.addBatch("insert into cfe_18.host_group_x_host values(2,3,'cfe')");
    ...
    public void testTagTriggerAccept() throws Exception {
        ...
        stmnt
                .addBatch(
                        "insert into cfe_18.capture_def_group(id,capture_def_group_name,capture_type,flow_id) values(20,'capture_group20','cfe',1)"
                );
        stmnt.executeBatch();
        stmnt.addBatch("insert into cfe_18.capture_def_group_x_capture_def values(5,5,5,'cfe',1)");
        stmnt.executeBatch();

        // Fetch database data after executing your code
        ITable actualTable = databaseConnection
                .createQueryTable(
                        "result", "select * from cfe_18.capture_def_group_x_capture_def order by capture_def_id asc"
                );
