...
USE cfe_03;
DELIMITER //
CREATE OR REPLACE PROCEDURE select_interface_in_meta(proc_host_meta_id INT, tx_id INT)
BEGIN
    ...
    FROM cfe_03.interfaces i
             INNER JOIN host_meta_x_interface hmxi ON i.id = hmxi.interface_id
