...
(
    ...
    constraint ´flow_id_TO_flows´ foreign key (flow_id) references cfe_18.flows (id),
    constraint ´flow_L7_id_TO_sink´ foreign key (flow_id, L7_id) references cfe_18.capture_sink (flow_id, L7_id),
...
(
    ...
    constraint host_group_id_TO_host_group foreign key (host_group_id) references cfe_18.host_group (id),
